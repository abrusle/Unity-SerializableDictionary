...
![General screenshot](Documentation~/SerializableDictionary_screenshot1.png)
...
- The inspector will handle invalid dictionary keys such as duplicated or `null` keys and warn the user that data loss can occur if the keys are not fixed.
    ...
    ![Conflicting keys screenshot](Documentation~/SerializableDictionary_screenshot2.png)

    ![Null key screenshot](Documentation~/SerializableDictionary_screenshot3.png)
